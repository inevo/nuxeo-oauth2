...
public class OAuth2ServiceProviderRegistryImpl extends DefaultComponent
	...
	public NuxeoOAuth2ServiceProvider getProvider(String serviceName) {
	   ...
	   public NuxeoOAuth2ServiceProvider addProvider(String serviceName, String tokenServerURL, String authorizationServerURL, 
	    		String clientId, String clientSecret, List<String> scopes) throws Exception {

		   NuxeoOAuth2ServiceProvider provider = new NuxeoOAuth2ServiceProvider(null, serviceName,
	 ...
	 protected String preProcessServiceName(String serviceName) {
	   ...
	   protected NuxeoOAuth2ServiceProvider getEntry(String serviceName, Set<String> ftFilter) throws Exception {
